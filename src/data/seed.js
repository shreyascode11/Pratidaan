...
export const SEED_ITEMS = [
  ...
  {
    id: 's19',
    title: 'White Molded Desk Chair',
    category: 'Freebies',
    type: 'Giveaway',
    price: null,
    condition: 'Used - Fair',
    description: 'Moving out and cannot take it. Needs a quick wipe down.',
    details: 'Molded seat on a wood dowel base, IKEA-style. Sturdy and comfortable for a desk chair. A couple of scuffs on the legs but otherwise in good shape. First come first serve.',
  ...
  },
  {
    ...
    details: 'Navy with a small logo patch. All zippers are functional. Just wiped it down yesterday.',
    image: img('photo-1553062407-98eeb64c6a62'),
    poster: 'Aditya Verma',
    location: 'Campus Gym',
    postedAt: daysAgo(0),
